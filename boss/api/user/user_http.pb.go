...
const OperationUserPageUser = "/api.user.User/PageUser"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	...
	r.POST("/api/user/v1", _User_CreateUser1_HTTP_Handler(srv))
	r.PUT("/api/user/:id", _User_UpdateUser0_HTTP_Handler(srv))
	r.PUT("/api/user/v1/:id", _User_UpdateUser1_HTTP_Handler(srv))
	r.DELETE("/api/user/:id", _User_DeleteUser0_HTTP_Handler(srv))
	r.DELETE("/api/user/v1/:id", _User_DeleteUser1_HTTP_Handler(srv))
	r.GET("/api/user/:id", _User_GetUser0_HTTP_Handler(srv))
	r.GET("/api/user/v1/:id", _User_GetUser1_HTTP_Handler(srv))
	r.POST("/api/user/list", _User_ListUser0_HTTP_Handler(srv))
	r.POST("/api/user/v1/list", _User_ListUser1_HTTP_Handler(srv))
	r.POST("/api/user/page", _User_PageUser0_HTTP_Handler(srv))
	r.POST("/api/user/v1/page", _User_PageUser1_HTTP_Handler(srv))
}
...
func _User_PageUser1_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in PageUserRequest
		if err := ctx.Bind(&in); err != nil {
			return err
